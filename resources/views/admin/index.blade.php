                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4">
                        <div class="card shadow-md bg-white border border-success mb-3">
                            <div class="card-body">
                                <span class="fw-semibold d-block mb-1 text-dark">Total Authors</span>
                                <h3 class="card-title mb-2">{{ $authorCount }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4">
                        <div class="card shadow-md bg-white border border-success mb-3">
                            <div class="card-body">
                                <span class="fw-semibold d-block mb-1 text-dark">Total Categories</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4">
                        <div class="card shadow-md bg-white border border-success mb-3">
                            <div class="card-body">
                                <span class="fw-semibold d-block mb-1 text-dark">Total Members</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4">
                        <div class="card shadow-md bg-white border border-success mb-3">
                            <div class="card-body">
                                <span class="fw-semibold d-block mb-1 text-dark">Total Librarians</span>
                                <h3 class="card-title mb-2">{{ $librarianCount }}</h3>
                            </div>
                        </div>
                    </div>
