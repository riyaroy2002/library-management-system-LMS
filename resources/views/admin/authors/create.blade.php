...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <h5 class="card-header">Create Author</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="contact_no"
                                ...
                                placeholder="10 digit contact number" value="{{ old('contact_no') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,10);">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="alt_contact_no"
                                ...
                                placeholder="Alternative contact number" value="{{ old('alt_contact_no') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,10);">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="bio" rows="4" class="form-control @error('bio') is-invalid @enderror"
                                placeholder="Short author bio">{{ old('bio') }}</textarea>
