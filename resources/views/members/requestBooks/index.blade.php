...
@section('title', 'My Book Issue History')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">

        <h4 class="fw-bold py-3 mb-4">
            <span class="text-dark fw-bold">Manage Issued / Requested Books</span>
        </h4>
        ...
        <div class="d-flex justify-content-end gap-2 mb-3">
            <a href="{{ route('books-request.books') }}" class="btn btn-success">
                <i class="bx bx-plus"></i> Request Book
            </a>
        </div>

        <div class="card">
            <h5 class="card-header">Issued / Requested Books</h5>
