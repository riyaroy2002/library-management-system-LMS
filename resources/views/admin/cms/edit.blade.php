...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <h5 class="card-header">Edit CMS</h5>
            @if ($errors->any())
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                placeholder="Enter title" value="{{ old('title', $cms->title) }}" id="title">
                            @error('title')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="slug" name="slug"
                                ...
                                value="{{ old('slug', $cms->slug) }}" readonly>
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="text_content" rows="5" class="form-control @error('text_content') is-invalid @enderror"
                                placeholder="Enter content">{{ old('text_content', $cms->text_content) }}</textarea>
                            @error('text_content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            @if ($cms->image_url)
                                <img src="{{ $cms->image_url }}" alt="CMS Image" class="img-fluid mt-2"
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <textarea name="extra" rows="3" class="form-control @error('extra') is-invalid @enderror"
                                placeholder='{"key":"value"}'>{{ old('extra', $cms->extra) }}</textarea>
                            @error('extra')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
