...
@section('title', 'Librarian Registration')
@section('content')
                ...
                <div class="col-lg-10">
                    <div class="donor-card">
                        <div class="donor-header">
                            <h4 class="mb-0 text-white">Librarian Registration</h4>
                        </div>
                        <div class="donor-body">
                            ...
                            <form method="POST" action="{{ route('librarian.register-librarian.store') }}">
                                @csrf
                                <div class="row g-4">
